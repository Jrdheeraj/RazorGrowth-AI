// Office design tokens — ported from munder-difflin (design/tokens.ts)
// Kept verbatim so the Pixi office renders identically.
// RazorGrowth global tokens live in src/styles/tokens.css — these are only for the office canvas engine.
