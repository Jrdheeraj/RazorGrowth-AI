...
# Google Ads app-level codes surfaced to the merchant (never raw Google JSON).
ERR_GOOGLE_ADS_ACCOUNT_NOT_LINKED = "GOOGLE_ADS_ACCOUNT_NOT_LINKED"
ERR_GOOGLE_ADS_AUTHENTICATION_FAILED = "GOOGLE_ADS_AUTHENTICATION_FAILED"
# Legacy alias kept so older references keep resolving to the same code.
ERR_GOOGLE_ACCOUNT_NOT_LINKED = ERR_GOOGLE_ADS_ACCOUNT_NOT_LINKED
